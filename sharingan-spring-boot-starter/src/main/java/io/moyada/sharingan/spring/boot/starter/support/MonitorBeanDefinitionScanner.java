...
import io.moyada.sharingan.spring.boot.starter.annotation.Monitor;
import io.moyada.sharingan.spring.boot.starter.config.SharinganConfig;
import io.moyada.sharingan.spring.boot.starter.context.HttpData;
...
import io.moyada.sharingan.spring.boot.starter.util.ListenerAnalyser;
...
public class MonitorBeanDefinitionScanner extends ClassPathBeanDefinitionScanner {
    ...
    public MonitorBeanDefinitionScanner(BeanDefinitionRegistry registry, SharinganConfig sharinganConfig, Register register) {
        ...
        if (null == sharinganConfig.getAttach()) {
            sharinganConfig.setAttach(Collections.<String, String>emptyMap());
        }
